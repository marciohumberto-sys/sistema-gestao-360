...
export const createAcao = async (tenantId, formData, axes) => {
    ...
    const payload = {
        ...
        budget_amount: formData.budget_amount !== undefined && formData.budget_amount !== '' ? formData.budget_amount : null,
        resource_source: formData.resource_source?.trim() || null,
    ...
    try {
        ...
        return updates.map(u => {
            ...
            return {
                ...
                author_name: u.author_name || null,
                descricao: u.summary || '',
                details: u.details || '',
